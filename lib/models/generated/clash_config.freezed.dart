...
mixin _$ProxyGroup {
 ...
 String get name;@JsonKey(fromJson: GroupType.parseProfileType) GroupType get type; List<String>? get proxies; List<String>? get use; int? get interval; bool? get lazy; String? get url; int? get timeout;@JsonKey(name: "max-failed-times") int? get maxFailedTimes; String? get filter;@JsonKey(name: "expected-filter") String? get excludeFilter;@JsonKey(name: "exclude-type") String? get excludeType;@JsonKey(name: "expected-status") int? get expectedStatus; bool? get hidden; String? get icon;
...
@useResult
$Res call({
 String name,@JsonKey(fromJson: GroupType.parseProfileType) GroupType type, List<String>? proxies, List<String>? use, int? interval, bool? lazy, String? url, int? timeout,@JsonKey(name: "max-failed-times") int? maxFailedTimes, String? filter,@JsonKey(name: "expected-filter") String? excludeFilter,@JsonKey(name: "exclude-type") String? excludeType,@JsonKey(name: "expected-status") int? expectedStatus, bool? hidden, String? icon
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name, @JsonKey(fromJson: GroupType.parseProfileType)  GroupType type,  List<String>? proxies,  List<String>? use,  int? interval,  bool? lazy,  String? url,  int? timeout, @JsonKey(name: "max-failed-times")  int? maxFailedTimes,  String? filter, @JsonKey(name: "expected-filter")  String? excludeFilter, @JsonKey(name: "exclude-type")  String? excludeType, @JsonKey(name: "expected-status")  int? expectedStatus,  bool? hidden,  String? icon)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProxyGroup() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name, @JsonKey(fromJson: GroupType.parseProfileType)  GroupType type,  List<String>? proxies,  List<String>? use,  int? interval,  bool? lazy,  String? url,  int? timeout, @JsonKey(name: "max-failed-times")  int? maxFailedTimes,  String? filter, @JsonKey(name: "expected-filter")  String? excludeFilter, @JsonKey(name: "exclude-type")  String? excludeType, @JsonKey(name: "expected-status")  int? expectedStatus,  bool? hidden,  String? icon)  $default,) {final _that = this;
switch (_that) {
case _ProxyGroup():
return $default(_that.name,_that.type,_that.proxies,_that.use,_that.interval,_that.lazy,_that.url,_that.timeout,_that.maxFailedTimes,_that.filter,_that.excludeFilter,_that.excludeType,_that.expectedStatus,_that.hidden,_that.icon);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey(name: "expected-status") final  int? expectedStatus;
...
mixin _$Tun {
 ...
 bool get enable; String get device; TunStack get stack;@JsonKey(name: "dns-hijack") List<String> get dnsHijack;@JsonKey(name: "route-address") List<String> get routeAddress;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,enable,device,stack,const DeepCollectionEquality().hash(dnsHijack),const DeepCollectionEquality().hash(routeAddress));
...
@useResult
$Res call({
 bool enable, String device, TunStack stack,@JsonKey(name: "dns-hijack") List<String> dnsHijack,@JsonKey(name: "route-address") List<String> routeAddress
});
...
/// Create a copy of Tun
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enable = null,Object? device = null,Object? stack = null,Object? dnsHijack = null,Object? routeAddress = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enable,  String device,  TunStack stack, @JsonKey(name: "dns-hijack")  List<String> dnsHijack, @JsonKey(name: "route-address")  List<String> routeAddress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Tun() when $default != null:
return $default(_that.enable,_that.device,_that.stack,_that.dnsHijack,_that.routeAddress);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enable,  String device,  TunStack stack, @JsonKey(name: "dns-hijack")  List<String> dnsHijack, @JsonKey(name: "route-address")  List<String> routeAddress)  $default,) {final _that = this;
switch (_that) {
case _Tun():
return $default(_that.enable,_that.device,_that.stack,_that.dnsHijack,_that.routeAddress);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool enable,  String device,  TunStack stack, @JsonKey(name: "dns-hijack")  List<String> dnsHijack, @JsonKey(name: "route-address")  List<String> routeAddress)?  $default,) {final _that = this;
switch (_that) {
case _Tun() when $default != null:
return $default(_that.enable,_that.device,_that.stack,_that.dnsHijack,_that.routeAddress);case _:
  return null;
...
class _Tun implements Tun {
  const _Tun({this.enable = false, this.device = appName, this.stack = TunStack.gvisor, @JsonKey(name: "dns-hijack") final  List<String> dnsHijack = const ["any:53"], @JsonKey(name: "route-address") final  List<String> routeAddress = const []}): _dnsHijack = dnsHijack,_routeAddress = routeAddress;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,enable,device,stack,const DeepCollectionEquality().hash(_dnsHijack),const DeepCollectionEquality().hash(_routeAddress));
...
/// Create a copy of Tun
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? enable = null,Object? device = null,Object? stack = null,Object? dnsHijack = null,Object? routeAddress = null,}) {
  return _then(_Tun(
enable: null == enable ? _self.enable : enable // ignore: cast_nullable_to_non_nullable
as bool,device: null == device ? _self.device : device // ignore: cast_nullable_to_non_nullable
as String,stack: null == stack ? _self.stack : stack // ignore: cast_nullable_to_non_nullable
...
@JsonKey(name: "proxy-groups") List<ProxyGroup> get proxyGroups; List<String> get rule;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClashConfigSnippet&&const DeepCollectionEquality().equals(other.proxyGroups, proxyGroups)&&const DeepCollectionEquality().equals(other.rule, rule));
}
...
@useResult
$Res call({
@JsonKey(name: "proxy-groups") List<ProxyGroup> proxyGroups, List<String> rule
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "proxy-groups")  List<ProxyGroup> proxyGroups,  List<String> rule)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClashConfigSnippet() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "proxy-groups")  List<ProxyGroup> proxyGroups,  List<String> rule)  $default,) {final _that = this;
switch (_that) {
case _ClashConfigSnippet():
return $default(_that.proxyGroups,_that.rule);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "proxy-groups")  List<ProxyGroup> proxyGroups,  List<String> rule)?  $default,) {final _that = this;
switch (_that) {
case _ClashConfigSnippet() when $default != null:
return $default(_that.proxyGroups,_that.rule);case _:
  return null;
...
class _ClashConfigSnippet implements ClashConfigSnippet {
  const _ClashConfigSnippet({@JsonKey(name: "proxy-groups") final  List<ProxyGroup> proxyGroups = const [], final  List<String> rule = const []}): _proxyGroups = proxyGroups,_rule = rule;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ClashConfigSnippet&&const DeepCollectionEquality().equals(other._proxyGroups, _proxyGroups)&&const DeepCollectionEquality().equals(other._rule, _rule));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mixedPort,mode,allowLan,logLevel,ipv6,findProcessMode,keepAliveInterval,unifiedDelay,tcpConcurrent,tun,dns,geoXUrl,geodataLoader,const DeepCollectionEquality().hash(proxyGroups),const DeepCollectionEquality().hash(rule),globalUa,externalController,const DeepCollectionEquality().hash(hosts));
...
/// Create a copy of ClashConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mixedPort = null,Object? mode = null,Object? allowLan = null,Object? logLevel = null,Object? ipv6 = null,Object? findProcessMode = null,Object? keepAliveInterval = null,Object? unifiedDelay = null,Object? tcpConcurrent = null,Object? tun = null,Object? dns = null,Object? geoXUrl = null,Object? geodataLoader = null,Object? proxyGroups = null,Object? rule = null,Object? globalUa = freezed,Object? externalController = null,Object? hosts = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "mixed-port")  int mixedPort,  Mode mode, @JsonKey(name: "allow-lan")  bool allowLan, @JsonKey(name: "log-level")  LogLevel logLevel,  bool ipv6, @JsonKey(name: "find-process-mode", unknownEnumValue: FindProcessMode.off)  FindProcessMode findProcessMode, @JsonKey(name: "keep-alive-interval")  int keepAliveInterval, @JsonKey(name: "unified-delay")  bool unifiedDelay, @JsonKey(name: "tcp-concurrent")  bool tcpConcurrent, @JsonKey(fromJson: Tun.safeFormJson)  Tun tun, @JsonKey(fromJson: Dns.safeDnsFromJson)  Dns dns, @JsonKey(name: "geox-url", fromJson: GeoXUrl.safeFormJson)  GeoXUrl geoXUrl, @JsonKey(name: "geodata-loader")  GeodataLoader geodataLoader, @JsonKey(name: "proxy-groups")  List<ProxyGroup> proxyGroups,  List<String> rule, @JsonKey(name: "global-ua")  String? globalUa, @JsonKey(name: "external-controller")  ExternalControllerStatus externalController,  HostsMap hosts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClashConfig() when $default != null:
return $default(_that.mixedPort,_that.mode,_that.allowLan,_that.logLevel,_that.ipv6,_that.findProcessMode,_that.keepAliveInterval,_that.unifiedDelay,_that.tcpConcurrent,_that.tun,_that.dns,_that.geoXUrl,_that.geodataLoader,_that.proxyGroups,_that.rule,_that.globalUa,_that.externalController,_that.hosts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "mixed-port")  int mixedPort,  Mode mode, @JsonKey(name: "allow-lan")  bool allowLan, @JsonKey(name: "log-level")  LogLevel logLevel,  bool ipv6, @JsonKey(name: "find-process-mode", unknownEnumValue: FindProcessMode.off)  FindProcessMode findProcessMode, @JsonKey(name: "keep-alive-interval")  int keepAliveInterval, @JsonKey(name: "unified-delay")  bool unifiedDelay, @JsonKey(name: "tcp-concurrent")  bool tcpConcurrent, @JsonKey(fromJson: Tun.safeFormJson)  Tun tun, @JsonKey(fromJson: Dns.safeDnsFromJson)  Dns dns, @JsonKey(name: "geox-url", fromJson: GeoXUrl.safeFormJson)  GeoXUrl geoXUrl, @JsonKey(name: "geodata-loader")  GeodataLoader geodataLoader, @JsonKey(name: "proxy-groups")  List<ProxyGroup> proxyGroups,  List<String> rule, @JsonKey(name: "global-ua")  String? globalUa, @JsonKey(name: "external-controller")  ExternalControllerStatus externalController,  HostsMap hosts)  $default,) {final _that = this;
switch (_that) {
case _ClashConfig():
return $default(_that.mixedPort,_that.mode,_that.allowLan,_that.logLevel,_that.ipv6,_that.findProcessMode,_that.keepAliveInterval,_that.unifiedDelay,_that.tcpConcurrent,_that.tun,_that.dns,_that.geoXUrl,_that.geodataLoader,_that.proxyGroups,_that.rule,_that.globalUa,_that.externalController,_that.hosts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "mixed-port")  int mixedPort,  Mode mode, @JsonKey(name: "allow-lan")  bool allowLan, @JsonKey(name: "log-level")  LogLevel logLevel,  bool ipv6, @JsonKey(name: "find-process-mode", unknownEnumValue: FindProcessMode.off)  FindProcessMode findProcessMode, @JsonKey(name: "keep-alive-interval")  int keepAliveInterval, @JsonKey(name: "unified-delay")  bool unifiedDelay, @JsonKey(name: "tcp-concurrent")  bool tcpConcurrent, @JsonKey(fromJson: Tun.safeFormJson)  Tun tun, @JsonKey(fromJson: Dns.safeDnsFromJson)  Dns dns, @JsonKey(name: "geox-url", fromJson: GeoXUrl.safeFormJson)  GeoXUrl geoXUrl, @JsonKey(name: "geodata-loader")  GeodataLoader geodataLoader, @JsonKey(name: "proxy-groups")  List<ProxyGroup> proxyGroups,  List<String> rule, @JsonKey(name: "global-ua")  String? globalUa, @JsonKey(name: "external-controller")  ExternalControllerStatus externalController,  HostsMap hosts)?  $default,) {final _that = this;
switch (_that) {
case _ClashConfig() when $default != null:
return $default(_that.mixedPort,_that.mode,_that.allowLan,_that.logLevel,_that.ipv6,_that.findProcessMode,_that.keepAliveInterval,_that.unifiedDelay,_that.tcpConcurrent,_that.tun,_that.dns,_that.geoXUrl,_that.geodataLoader,_that.proxyGroups,_that.rule,_that.globalUa,_that.externalController,_that.hosts);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mixedPort,mode,allowLan,logLevel,ipv6,findProcessMode,keepAliveInterval,unifiedDelay,tcpConcurrent,tun,dns,geoXUrl,geodataLoader,const DeepCollectionEquality().hash(_proxyGroups),const DeepCollectionEquality().hash(_rule),globalUa,externalController,const DeepCollectionEquality().hash(_hosts));
...
/// Create a copy of ClashConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mixedPort = null,Object? mode = null,Object? allowLan = null,Object? logLevel = null,Object? ipv6 = null,Object? findProcessMode = null,Object? keepAliveInterval = null,Object? unifiedDelay = null,Object? tcpConcurrent = null,Object? tun = null,Object? dns = null,Object? geoXUrl = null,Object? geodataLoader = null,Object? proxyGroups = null,Object? rule = null,Object? globalUa = freezed,Object? externalController = null,Object? hosts = null,}) {
