...
String _$isAccessControlHash() => r'e2403e7de32c30a09add583b5378ac52a7df95ef';

/// See also [IsAccessControl].
@ProviderFor(IsAccessControl)
final isAccessControlProvider =
    AutoDisposeNotifierProvider<IsAccessControl, bool>.internal(
  IsAccessControl.new,
  name: r'isAccessControlProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$isAccessControlHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
String _$accessControlSettingHash() =>
    r'03c9d8841c807874045b241f55a0a706f3846821';

/// See also [AccessControlSetting].
@ProviderFor(AccessControlSetting)
final accessControlSettingProvider =
    AutoDisposeNotifierProvider<AccessControlSetting, AccessControl>.internal(
  AccessControlSetting.new,
  name: r'accessControlSettingProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$accessControlSettingHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
